...
const Profile = ({ data }: IProps) => {
  const [showUserVieos, setShowUserVideos] = useState(true);
    ...
    <div className="w-full">
      <div className="flex gap-6 md:gap-10 mb-4 bg-white w-full">
        ...
        <div className="flex flex-col justify-center">
          <p className="md:text-2xl tracking-winder flex gap-1 items-center justify-center text-md font-bold text-primary lowercase mt-1">
      ...
      <div>
        ...
        <div className="flex gap-6 flex-wrap md:justify-start">
          {videosList.length > 0 ? (
            ...
            <NoResults text={`No ${showUserVieos ? "" : "Liked"} Videos Yet`} />
          )}
        </div>
      </div>
    </div>
